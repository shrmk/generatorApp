...
tOCTVOCSAMPLES_APP_CFG g_AppCfg =
{
    ...
    /* Host's settings. */
    { { cOCTVC1_IP_VERSION_ENUM_4, { 0xC0A80040, 0, 0, 0 } }, 49152 }, /* Host's RTP UDP address [192.168.0.100:49152]. */
    { { cOCTVC1_IP_VERSION_ENUM_4, { 0xC0A80040, 0, 0, 0 } }, 49153 }, /* Host's RTCP UDP address [192.168.0.100:49153]. */
    "host1@octasic.com",                                                /* Host's RTCP canonical name. */
    /* Vocallo's settings. */
    0,                                                                 /* Vocallo host's Ethernet port (port 0 or 1). */
    { cOCTVC1_IP_VERSION_ENUM_4, { 0xC0A80048, 0, 0, 0 } },            /* Vocallo host's IP address [192.168.0.64]. */
    { cOCTVC1_IP_VERSION_ENUM_4, { 0xFFFFFF00, 0, 0, 0 } },            /* Vocallo host's network mask [255.255.255.0]. */
    49152,                                                             /* RTP member's RTP UDP port. */
    49153,                                                             /* RTP member's RTCP UDP port. */
    0,                                                                 /* RTP member's RTP payload type */
    cOCTVOCNET_PKT_D_TYPE_ENUM_PCM_U_LAW,                              /* RTP member's packet encoding type */
    "rtp_member1@octasic.com"                                           /* RTP member's RTCP canonical name. */
};
