...
typedef struct tOCTVOCSAMPLES_APP_CTX_TAG
{
    ...
    tOCTVC1_HANDLE              hVocTermA;      /* Voice termination A's handle. */
    tOCTVC1_HANDLE              hRtpSessionA;   /* RTP session A's handle. */
    tOCT_UINT32                 ulRtpMemberIdA; /* RTP member A's ID. */
    tOCTVC1_HANDLE              hVocalloHostB;  /* Vocallo host B's handle. */
    tOCTVC1_HANDLE              hVocTermB;      /* Voice termination B's handle. */
    tOCTVC1_HANDLE              hRtpSessionB;   /* RTP session B's handle. */
    tOCT_UINT32                 ulRtpMemberIdB; /* RTP member B's ID. */
...
tOCTVOCSAMPLES_APP_CFG g_AppCfg =
{
    ...
    /* Side A's settings. */
    { { cOCTVC1_IP_VERSION_ENUM_4, { 0xC0A80064, 0, 0, 0 } }, 49152 }, /* Host A's RTP UDP address [192.168.0.100:49152]. */
    { { cOCTVC1_IP_VERSION_ENUM_4, { 0xC0A80064, 0, 0, 0 } }, 49153 }, /* Host A's RTCP UDP address [192.168.0.100:49153]. */
...
static int CloseSideA(void);
static int CloseSideB(void);
...
static int CreateSideA(void)
{
    ...
    \*************************************************************************/
    {
         ...
         */
        g_AppCtx.hVocTermA = TermOpenRsp.hTerm;
    }
    ...
    \*************************************************************************/
    {
         ...
         */
        g_AppCtx.hRtpSessionA = RtpSessionOpenRsp.hRtpSession;
    }
    ...
    \*************************************************************************/
    {
        ...
        RtpSessionActivateMemberCmd.hRtpSession                        = g_AppCtx.hRtpSessionA;
        RtpSessionActivateMemberCmd.hTerm                              = g_AppCtx.hVocTermA;
         ...
         */
        g_AppCtx.ulRtpMemberIdA = RtpSessionActivateMemberRsp.ulLocalMemberId;
    }
...
static int CloseSideA(void)
{
    ...
    if (cOCTVC1_HANDLE_INVALID != g_AppCtx.hRtpSessionA.aulHandle[0])
    {
        ...
        RtpSessionDeactivateMemberCmd.hRtpSession     = g_AppCtx.hRtpSessionA;
        RtpSessionDeactivateMemberCmd.ulLocalMemberId = g_AppCtx.ulRtpMemberIdA;
    ...
    if (cOCTVC1_HANDLE_INVALID != g_AppCtx.hRtpSessionA.aulHandle[0])
    {
        ...
        RtpSessionCloseCmd.hRtpSession = g_AppCtx.hRtpSessionA;
        ...
        g_AppCtx.hRtpSessionA.aulHandle[0] = cOCTVC1_HANDLE_INVALID;
    }
    ...
    if (cOCTVC1_HANDLE_INVALID != g_AppCtx.hVocTermA.aulHandle[0])
    {
        ...
        TermCloseCmd.hTerm = g_AppCtx.hVocTermA;
        ...
        g_AppCtx.hVocTermA.aulHandle[0] = cOCTVC1_HANDLE_INVALID;
    }
...
static int CreateSideB(void)
{
    ...
    \*************************************************************************/
    {
         ...
         * Save the handle of the opened voice termination.
         */
        g_AppCtx.hVocTermB = TermOpenRsp.hTerm;
    }
    ...
    \*************************************************************************/
    {
         ...
         * Save the handle of the opened RTP session.
         */
        g_AppCtx.hRtpSessionB = RtpSessionOpenRsp.hRtpSession;
    }
    ...
    \*************************************************************************/
    {
         ...
         */
        mOCTVC1_NET_MSG_RTP_SESSION_ACTIVATE_MEMBER_CMD_DEF(&RtpSessionActivateMemberCmd);
        RtpSessionActivateMemberCmd.hRtpSession                        = g_AppCtx.hRtpSessionB;
        RtpSessionActivateMemberCmd.hTerm                              = g_AppCtx.hVocTermB;
        RtpSessionActivateMemberCmd.ulRxPktFilter                      = cOCTVC1_NET_RX_PKT_FILTER_ENUM_NONE;
         ...
         * Save the ID of the activated RTP member.
         */
        g_AppCtx.ulRtpMemberIdB = RtpSessionActivateMemberRsp.ulLocalMemberId;
    }
...
static int CloseSideB(void)
{
    ...
    if (cOCTVC1_HANDLE_INVALID != g_AppCtx.hRtpSessionB.aulHandle[0])
    {
        tOCTVC1_NET_MSG_RTP_SESSION_DEACTIVATE_MEMBER_CMD RtpSessionDeactivateMemberCmd;
        tOCTVC1_NET_MSG_RTP_SESSION_DEACTIVATE_MEMBER_RSP RtpSessionDeactivateMemberRsp;
        tOCTVC1_PKT_API_CMD_EXECUTE_PARMS                 CmdExecuteParms;
         ...
         */
        mOCTVC1_NET_MSG_RTP_SESSION_DEACTIVATE_MEMBER_CMD_DEF(&RtpSessionDeactivateMemberCmd);
        RtpSessionDeactivateMemberCmd.hRtpSession     = g_AppCtx.hRtpSessionB;
        RtpSessionDeactivateMemberCmd.ulLocalMemberId = g_AppCtx.ulRtpMemberIdB;
        mOCTVC1_NET_MSG_RTP_SESSION_DEACTIVATE_MEMBER_CMD_SWAP(&RtpSessionDeactivateMemberCmd);
    ...
    if (cOCTVC1_HANDLE_INVALID != g_AppCtx.hRtpSessionB.aulHandle[0])
    {
         ...
         */
        mOCTVC1_NET_MSG_RTP_SESSION_CLOSE_CMD_DEF(&RtpSessionCloseCmd);
        RtpSessionCloseCmd.hRtpSession = g_AppCtx.hRtpSessionB;
        mOCTVC1_NET_MSG_RTP_SESSION_CLOSE_CMD_SWAP(&RtpSessionCloseCmd);
        ...
        g_AppCtx.hRtpSessionB.aulHandle[0] = cOCTVC1_HANDLE_INVALID;
    }
    ...
    if (cOCTVC1_HANDLE_INVALID != g_AppCtx.hVocTermB.aulHandle[0])
    {
        tOCTVC1_VSPMP_VOC_MSG_TERM_CLOSE_CMD TermCloseCmd;
        tOCTVC1_VSPMP_VOC_MSG_TERM_CLOSE_RSP TermCloseRsp;
        tOCTVC1_PKT_API_CMD_EXECUTE_PARMS    CmdExecuteParms;
         ...
         */
        mOCTVC1_VSPMP_VOC_MSG_TERM_CLOSE_CMD_DEF(&TermCloseCmd);
        TermCloseCmd.hTerm = g_AppCtx.hVocTermB;
        mOCTVC1_VSPMP_VOC_MSG_TERM_CLOSE_CMD_SWAP(&TermCloseCmd);
        ...
        g_AppCtx.hVocTermB.aulHandle[0] = cOCTVC1_HANDLE_INVALID;
    }
...
static int ConnectTerms(void)
{
    ...
    TermConnectCmd.hTermFirst  = g_AppCtx.hVocTermA;
    TermConnectCmd.hTermSecond = g_AppCtx.hVocTermB;
...
static int DisconnectTerms(void)
{
    if (cOCTVC1_HANDLE_INVALID != g_AppCtx.hVocTermA.aulHandle[0])
    {
        ...
        TermDisconnectCmd.hTerm = g_AppCtx.hVocTermA;
